...
Проект включает в себя следующее:
  - **Технологии:** Java 8, GitHub/Git, JUnit, Logging, GSON, JAXB, SQL, PostgreSQL, Сервлеты, HTML, JSP, JSTL, Tomcat, JDBC, JavaScript и многое другое
...
[Приложение на Heroku (временная ссылка)](https://baseresumesapp.herokuapp.com/)
